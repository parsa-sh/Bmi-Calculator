      ...
      <Container bgColor="white" border="2px solid grey" borderRadius="18px" padding="40px">
        ...
        <VStack marginTop="50px">
          <HStack>
            ...
            <Input placeholder="Enter your height" border="2px solid #b8b8b8" />
          </HStack>
          <HStack marginTop="20px">
            <Text fontWeight="500">Weight (kg)</Text>
            <Input placeholder="Enter your weight"  border="2px solid #b8b8b8"/>
          </HStack>
          <Button marginTop="30px" border="4px solid #b8b8b8" borderRadius="12px" padding="20px" fontWeight="700">Calculate BMI</Button>
          <HStack marginTop="30px">
            <Text fontWeight="600" fontSize="24px">BMI :</Text>
            <Text fontSize="24px">34.7</Text>
          </HStack>
